...
INSERT INTO student_profiles (user_id, tenant_id, roll_number, department, branch, batch_year, graduation_year, cgpa, tenth_percentage, twelfth_percentage, gender, placement_status, is_verified, bio) VALUES
  ('b1000000-0000-0000-0000-000000000030', 'a1000000-0000-0000-0000-000000000004', 'JU2021CS001', 'Computer Science & Engineering', 'Computer Science & Engineering', 2021, 2025, 8.40, 92.0, 90.0, 'female', 'unplaced', true, 'Rimjhim Bose — final-year CSE, Jadavpur University. Interested in backend systems and distributed computing.'),
  ('b1000000-0000-0000-0000-000000000031', 'a1000000-0000-0000-0000-000000000004', 'JU2021CS002', 'Computer Science & Engineering', 'Computer Science & Engineering', 2021, 2025, 7.85, 89.0, 87.5, 'male', 'unplaced', true, 'Subhajit Mukherjee — final-year CSE, Jadavpur University. Competitive programming and algorithms.'),
  ('b1000000-0000-0000-0000-000000000032', 'a1000000-0000-0000-0000-000000000004', 'JU2021EC001', 'Electronics & Telecommunication', 'Electronics & Telecommunication Engineering', 2021, 2025, 8.10, 91.0, 88.0, 'female', 'unplaced', true, 'Priyanka Das — final-year ETCE, Jadavpur University. Signal processing and embedded interest.'),
  ('b1000000-0000-0000-0000-000000000033', 'a1000000-0000-0000-0000-000000000005', 'VIT2021CS101', 'Computer Science & Engineering', 'Computer Science & Engineering', 2021, 2025, 8.65, 93.0, 91.0, 'male', 'unplaced', true, 'Harish Venkatesan — final-year CSE, VIT Vellore. Full-stack and cloud deployments.'),
  ('b1000000-0000-0000-0000-000000000034', 'a1000000-0000-0000-0000-000000000005', 'VIT2021CS102', 'Computer Science & Engineering', 'Computer Science & Engineering', 2021, 2025, 9.05, 95.0, 93.0, 'female', 'unplaced', true, 'Divya Subramanian — final-year CSE, VIT Vellore. ML and data engineering.'),
  ('b1000000-0000-0000-0000-000000000035', 'a1000000-0000-0000-0000-000000000005', 'VIT2021IT101', 'Information Technology', 'Information Technology', 2021, 2025, 8.20, 90.0, 89.0, 'female', 'unplaced', true, 'Nithya Krishnamoorthy — final-year IT, VIT Vellore. Security and DevOps.'),
  ('b1000000-0000-0000-0000-000000000036', 'a1000000-0000-0000-0000-000000000006', 'DTU2021CO001', 'Computer Engineering', 'Computer Engineering', 2021, 2025, 8.55, 92.5, 91.0, 'female', 'unplaced', true, 'Zoya Siddiqui — final-year COE, DTU. Systems programming and OS.'),
  ('b1000000-0000-0000-0000-000000000037', 'a1000000-0000-0000-0000-000000000006', 'DTU2021CO002', 'Computer Engineering', 'Computer Engineering', 2021, 2025, 7.95, 88.0, 86.0, 'male', 'unplaced', true, 'Kabir Ahuja — final-year COE, DTU. Mobile and product engineering.'),
  ('b1000000-0000-0000-0000-000000000038', 'a1000000-0000-0000-0000-000000000006', 'DTU2021SE001', 'Software Engineering', 'Software Engineering', 2021, 2025, 8.75, 94.0, 92.0, 'female', 'unplaced', true, 'Simran Kaur — final-year Software Engineering, DTU. Platform engineering and SRE.'),
  ('b1000000-0000-0000-0000-000000000039', 'a1000000-0000-0000-0000-000000000007', 'IIITH2021CSE001', 'Computer Science', 'Computer Science & Engineering', 2021, 2025, 9.10, 96.0, 94.0, 'male', 'unplaced', true, 'Vivaan Rao — final-year CSE, IIIT Hyderabad. Research interest in NLP and HCI.'),
  ('b1000000-0000-0000-0000-000000000040', 'a1000000-0000-0000-0000-000000000007', 'IIITH2021CSE002', 'Computer Science', 'Computer Science & Engineering', 2021, 2025, 8.90, 95.0, 93.5, 'female', 'unplaced', true, 'Kavya Sriram — final-year CSE, IIIT Hyderabad. Computer vision and robotics.'),
  ('b1000000-0000-0000-0000-000000000041', 'a1000000-0000-0000-0000-000000000007', 'IIITH2021CSD001', 'Computational Linguistics', 'Dual Degree CSE', 2021, 2026, 8.35, 93.0, 91.0, 'male', 'unplaced', true, 'Dhruv Malhotra — dual-degree CSE, IIIT Hyderabad. CL and speech tech.')
...
INSERT INTO employer_profiles (id, user_id, company_name, company_slug, industry, company_type, company_size, website, description, headquarters, locations) VALUES
  ('c1000000-0000-0000-0000-000000000010', 'b1000000-0000-0000-0000-000000000050', 'Tata Consultancy Services (TCS)', 'tcs', 'Global IT Services', 'mnc', '600000+', 'https://www.tcs.com', 'AI, cloud modernization, digital engineering. Global IT services at scale.', 'Mumbai, India', ARRAY['Mumbai', 'Bangalore', 'Chennai', 'Pune', 'Hyderabad']),
  ('c1000000-0000-0000-0000-000000000011', 'b1000000-0000-0000-0000-000000000051', 'Quess Corp', 'quess-corp', 'Technology-enabled staffing', 'private', 'Not disclosed', 'https://www.quesscorp.com', 'Technology-enabled staffing; expansion of HR-tech providers.', 'Bangalore, India', ARRAY['Bangalore', 'Mumbai', 'Delhi NCR']),
  ('c1000000-0000-0000-0000-000000000012', 'b1000000-0000-0000-0000-000000000052', 'Accenture', 'accenture', 'Engineering, Information Technology, Business Development', 'mnc', 'Not disclosed', 'https://www.accenture.com', 'Management consulting and technology services.', 'Dublin, Ireland', ARRAY['Bangalore', 'Mumbai', 'Hyderabad', 'Pune']),
  ('c1000000-0000-0000-0000-000000000013', 'b1000000-0000-0000-0000-000000000053', 'Amazon', 'amazon', 'Engineering, Operations, Sales', 'mnc', 'Not disclosed', 'https://www.amazon.jobs', 'Cloud computing, e-commerce, and operations at scale.', 'Seattle, USA', ARRAY['Bangalore', 'Hyderabad', 'Chennai', 'Mumbai']),
  ('c1000000-0000-0000-0000-000000000014', 'b1000000-0000-0000-0000-000000000054', 'Wipro', 'wipro', 'IT services, consulting', 'mnc', 'Not disclosed', 'https://www.wipro.com', 'IT services and consulting; broad service expansion.', 'Bangalore, India', ARRAY['Bangalore', 'Hyderabad', 'Pune', 'Chennai']),
  ('c1000000-0000-0000-0000-000000000015', 'b1000000-0000-0000-0000-000000000055', 'EdgeVerve', 'edgeverve', 'Information Technology', 'mnc', 'Not disclosed', 'https://www.edgeverve.com', 'Software development and product engineering (Infosys subsidiary).', 'Bangalore, India', ARRAY['Bangalore', 'Mumbai']),
  ('c1000000-0000-0000-0000-000000000016', 'b1000000-0000-0000-0000-000000000056', 'Panaya', 'panaya', 'Information Technology', 'private', 'Not disclosed', 'https://www.panaya.com', 'Software development and maintenance for enterprise change intelligence.', 'Hackensack, USA', ARRAY['Bangalore', 'Tel Aviv']),
  ('c1000000-0000-0000-0000-000000000017', 'b1000000-0000-0000-0000-000000000057', 'Droga5', 'droga5', 'Engineering, Information Technology', 'private', 'Not disclosed', 'https://droga5.com', 'Creative agency with engineering and technology capabilities (Accenture Song).', 'New York, USA', ARRAY['New York', 'London', 'Tokyo'])
ON CONFLICT (id) DO NOTHING;
