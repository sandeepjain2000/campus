...
- Name: c3_transactional.spec.js >> C-3 Transactional Flows & Cross-Role Visibility >> C3-TXN-002 – Create job posting -> visible in student opportunities
- Location: qa\tests\c3_transactional.spec.js:82:3

# Error details

```
Error: Login failed for hr@techcorp.com — URL stuck at: http://127.0.0.1:3000/login?email=hr%40techcorp.com
```
