...
- Name: c4_data_validation.spec.js >> C4 - Super Admin Data Validation >> C4-ADM-003 - Users list and roles
- Location: qa\tests\c4_data_validation.spec.js:143:3

# Error details

```
Error: Login failed for admin@placementhub.com — URL stuck at: http://127.0.0.1:3000/login?email=admin%40placementhub.com
```
