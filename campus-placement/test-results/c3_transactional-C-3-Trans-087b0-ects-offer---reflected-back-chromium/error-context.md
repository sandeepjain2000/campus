...
- Name: c3_transactional.spec.js >> C-3 Transactional Flows & Cross-Role Visibility >> C3-TXN-007 – Student accepts/rejects offer -> reflected back
- Location: qa\tests\c3_transactional.spec.js:189:3

# Error details

```
Error: Login failed for arjun.verma@iitm.edu — URL stuck at: http://127.0.0.1:3000/login?email=arjun.verma%40iitm.edu
```
