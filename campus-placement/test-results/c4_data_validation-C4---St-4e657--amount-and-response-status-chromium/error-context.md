...
- Name: c4_data_validation.spec.js >> C4 - Student Data Validation >> C4-STU-004 - Offer amount and response status
- Location: qa\tests\c4_data_validation.spec.js:52:3
...
Call log:
  - navigating to "http://127.0.0.1:3000/dashboard/student/offers", waiting until "load"
