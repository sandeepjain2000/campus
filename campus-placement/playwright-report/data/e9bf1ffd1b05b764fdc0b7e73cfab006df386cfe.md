...
- Name: c12_use_cases.spec.js >> C12 - Use Case Executability >> C12-UC-003 - Student application lifecycle
- Location: qa\tests\c12_use_cases.spec.js:45:3
...
waiting for navigation until "load"
  navigated to "http://127.0.0.1:3000/login?email=arjun.verma%40iitm.edu"
  navigated to "http://127.0.0.1:3000/login?email=arjun.verma%40iitm.edu"
============================================================
```
