...
const MANIFEST_PATH = path.join(__dirname, 'use-case-runners.json');
const UC_PATH = path.join(__dirname, 'use-cases.json');
const TOURS_PATH = path.join(__dirname, 'use-case-tours.json');
