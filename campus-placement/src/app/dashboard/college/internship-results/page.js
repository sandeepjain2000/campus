    ...
    <div className="animate-fadeIn">
      <div className="page-header">
        <div className="page-header-left">
          ...
          <p className="text-secondary">Track student internship outcomes, offers, and academic credits (demo table).</p>
        </div>
          ...
          <tbody>
            {mockInternships.map((intern) => (
              <tr key={intern.id}>
                ...
                <td>
                  <button type="button" className="btn btn-ghost btn-sm" onClick={() => alert('Feature coming soon! (Wireframe Action)')}>
