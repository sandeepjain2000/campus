...
import { Briefcase, Eye, X, ExternalLink } from 'lucide-react';
      ...
      <div className="page-header">
        ...
        <div className="page-header-actions">
          <span className="badge badge-blue" style={{ padding: '0.5rem 1rem', fontSize: '0.875rem' }}>
            {items.length} job{items.length !== 1 ? 's' : ''} available
          </span>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            {!selectedRow.hasApplied && (
              ...
              >
                {applyingId === selectedRow.id ? 'Applying…' : canApply ? 'Apply to this Job' : 'Upload CV to apply'}
              </button>
            )}
          </div>
        </div>
